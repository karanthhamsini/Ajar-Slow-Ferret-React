        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text18">#about-me</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text14">#education</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text25">#experience</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text20">#skills</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text17">Contact Me</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Download CV</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text27">About Me</span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text15">
                                  Explore my educational qualifications and
                                  achievements.
                                </span>
                              </Fragment>
                            )}
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text21">Education</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text24">Experience</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  action1: undefined,
  page4ImageAlt: 'Skills Image',
  link1: undefined,
  page2ImageAlt: 'Education Image',
  page4: undefined,
  page3ImageAlt: 'Experience Image',
  link4: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1729821728580-fa2b3efed2bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1Nzc4ODI1NXw&ixlib=rb-4.1.0&q=80&w=1080',
  page2: undefined,
  page4Description: undefined,
  action2: undefined,
  logoAlt: 'Personal Website Logo',
  page3: undefined,
  link3: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1754424612239-677364e244d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1Nzc4ODI1NHw&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page3Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1729821728580-fa2b3efed2bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1Nzc4ODI1NHw&ixlib=rb-4.1.0&q=80&w=1080',
  page1: undefined,
  linkUrlPage4: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1590596295076-421670fed01b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1Nzc4ODI1M3w&ixlib=rb-4.1.0&q=80&w=1080',
}
